	...
	<div class="container-fluid">
		<div class="row page-titles">
	        <div class="col-md-5 col-12 align-self-center">
	            <h3 class="text-themecolor mb-0">Edit Member</h3>
	        </div>
	    </div><br>
	    <div class="card">
            ...
            <form class="form-horizontal" id="form_update">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        <label for="member" class="col-sm-3 text-end control-label col-form-label">Name</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="member" name="member" value="{{$data->member}}" placeholder="Name">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="desciption" class="col-sm-3 text-end control-label col-form-label">Description</label>
                        <div class="col-sm-9">
                        <textarea class="form-control" id="desciption"  name="desciption">{{$data->desciption}}</textarea>
                        <!-- <input type="text" class="form-control" id="desciption" name="desciption" value="{{$data->desciption}}" placeholder="Commission"> -->
                        </div>
                    </div>
