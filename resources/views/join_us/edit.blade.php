    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Edit Join Us As Our Employee / Agent / Advisor / Franchisee</h3>
            </div>
        </div><br>
        <div class="card">
            <div class="card-body border-bottom">
                <h4 class="card-title">Edit Join Us As Our Employee / Agent / Advisor / Franchisee</h4>
            </div>
