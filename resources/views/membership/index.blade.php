    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Membership And Top-Up Plans</h3>
            </div>
        </div><br>
        ...
        <div class="card">
            <div class="d-flex border-bottom title-part-padding align-items-center">
                <div>
                    <h4 class="card-title mb-0">Membership And Top-Up Plans<a href="{{route('membership.add')}}" class="btn btn-rounded btn-primary">Add</a></h4>
                </div>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    ...
    function delete_function(id) {
        swal({
            title: 'Delete',
            text: 'The Membership will be deleted',
            icon: "warning",
            buttons: true,
            dangerMode: true,
        }).then((willDelete) => {
            if (willDelete) {
                var href = "{{route('membership.delete')}}";
                var data = id;
                $.ajax({
                    headers: {
