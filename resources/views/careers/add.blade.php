    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Add Careers</h3>
            </div>
        </div><br>
        <div class="card">
...
<script type="text/javascript">
    ...
    $('#save_btn').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('careers.insert')}}",
            data: $('#form_add').find("input[name!=metavalue]").serialize() + "&active=" + active + "&metavalue=" + metavalue,
