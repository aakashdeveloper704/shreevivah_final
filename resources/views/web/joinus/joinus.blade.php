...
@include('header.header')
  ...
  <div class="bg-image text-center shadow-1-strong rounded text-dark" style="background-image: url('./images/pink-web-bg.jpg');height:auto;"> 
        <div class="container ">
          ...
          <div class="centered txt">Join us As Our Employee / Agent / Advisor / Franchise</div>  
        </div>
    ...
    <div class="btnright">
    <div id="btn1">
    <button class="plan container">Register</button>
    </div>
    <div id="btn2">
    <button class="plan container">Login</button>
    </div>
    <div id="btn3">
