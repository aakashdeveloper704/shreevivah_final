...
.page-item.disabled .page-link{
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    ...
    <title>Shortlisted Profile</title>
  </head>
  <body>
...
@include('header.header')    
  ...
  border-color: #800080;" >
      ...
      <b>Shortlisted Profile</b>
</h1> 
    
    
    <div class="container" style="background-color:#fffff0;color:#bd1769;padding: 15px; height:auto; margin-top: 35px">
    <h6 class="text-sm-left" style="background-color:#bbe8bb;color:#145603;padding: 7px; height:30px;margin-top: 5px">
      <b>You have 32 shortlisted profile.</b>
</h6>
