	...
	<div class="container-fluid">
		<div class="row page-titles">
	        <div class="col-md-5 col-12 align-self-center">
	            <h3 class="text-themecolor mb-0">Pricing</h3>
	        </div>
	    </div><br>
	    ...
	    <div class="card">
            <div class="d-flex border-bottom title-part-padding align-items-center">
                <div>
                    <h4 class="card-title mb-0">Pricing <a href="{{route('pricing.add')}}" class="btn btn-rounded btn-primary">Add</a></h4>
                </div>
            </div>
            <div class="card-body">
...
$(document).ready( function(){
 users_table = $('#dataTable').DataTable({
    ...
    "columnDefs": [
        ...
        {render: function (data, type, row, meta) {
            // alert(data);
            return (data != '' && data != null) ? '<img src="images/pricing/'+data+'" width="50" height="50">': '';
        },
        "targets": -6,
        }
    ]
